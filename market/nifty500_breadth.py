...
class Nifty500Breadth:
 ...
 def snapshot(self,force=False):
  ...
  # The index quote is optional and must never block the 500-stock result.
  nifty=None
  try:
