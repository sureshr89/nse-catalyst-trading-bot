...
try:
    ...
    .title,.lab{color:#AAB6C3!important}
    .val,.big,.shead{color:#F5F7FB!important}
    .pill{background:#092C32!important;color:#5DE7F5!important}
    .strat{border-left-color:#00D9FF!important}
    ...
    .hero h1,.hero small,.hero .time{color:#F5F7FB!important}
    .stMarkdown h3{color:#F5F7FB!important}
    </style>
