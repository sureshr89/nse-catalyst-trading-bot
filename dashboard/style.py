...
/* Dashboard headings/text only — do not force a font on every Streamlit DOM node. */
...
.stApp p,.stApp li,.stApp .stMarkdown,[data-testid="stMarkdownContainer"] {
    font-family:var(--dash-font)!important;font-size:.82rem!important;line-height:1.4!important;
}
.stApp .stCaption{font-family:var(--dash-font)!important;color:#9FB0C7!important;font-size:.78rem!important}

/* Shared dashboard buttons; leave other Streamlit controls untouched. */
.stButton>button,.stDownloadButton>button {
    font-family:var(--dash-font)!important;font-size:.80rem!important;font-weight:650!important;
    line-height:1.15!important;min-height:40px!important;border-radius:9px!important;
}
