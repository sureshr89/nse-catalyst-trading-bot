...
.analysis-kpi span{display:block;color:#9FB0C7;font-size:.67rem;line-height:1.15}.analysis-kpi strong{display:block;color:#F4F7FB;font-size:.95rem;line-height:1.25;margin-top:4px}.analysis-section-title{font-size:1.02rem;font-weight:700;color:#F4F7FB;margin:2px 0 2px}
.stTabs [data-baseweb="tab-list"]{gap:5px;overflow-x:auto;padding:3px 2px 6px;scrollbar-width:none}.stTabs [data-baseweb="tab-list"]::-webkit-scrollbar{display:none}
.stTabs [data-baseweb="tab"]{height:38px;padding:0 12px;border:1px solid #26344D;border-radius:9px;background:#111B2D;color:#B9C6D8;font-size:.76rem;font-weight:650;white-space:nowrap}.stTabs [aria-selected="true"]{background:#1a2942!important;color:#F4F7FB!important;border-color:#3b5278!important}.stTabs [data-baseweb="tab-highlight"]{display:none}
.stPlotlyChart{border:1px solid #1f2c42;border-radius:10px;overflow:hidden;background:#101724}.stDataFrame{border-radius:10px}
.daily-motivation{margin-top:12px;padding:14px 13px;border:1px solid #2b3b57;border-radius:12px;background:linear-gradient(180deg,#142036,#101824);text-align:center}.daily-motivation-label{font-size:.68rem;font-weight:700;letter-spacing:.08em;color:#8fa6c4;margin-bottom:4px}.daily-motivation-quote{font-size:.95rem;font-weight:700;line-height:1.4;color:#f4f7fb}.daily-motivation-note{font-size:.70rem;color:#9fb0c7;margin-top:4px}.mobile-bottom-space{height:70px}
footer,header{visibility:hidden}
@media(max-width:1100px){.metric-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.analysis-kpi-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
