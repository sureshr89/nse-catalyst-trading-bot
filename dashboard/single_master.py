...
def live_dashboard():
 ...
 try:
  ...
  market={"complete":False,"sector_complete":False,"evaluated":0,"sector_priced":0,"nifty500_change_pct":None,"ad_ratio":None,"advances":0,"declines":0,"unchanged":0,"positive_sectors":0,"negative_sectors":0,"reason":str(exc),"quote_rows":pd.DataFrame()};dhan_ok=False;api_status={"ok":False,"message":str(exc)}
