...
@media(max-width:768px){
 ...
 .st-key-nav_grid [data-testid="stHorizontalBlock"]{flex-wrap:wrap!important;gap:.35rem!important}
 .st-key-nav_grid [data-testid="stColumn"]{width:calc(50% - .175rem)!important;flex:0 0 calc(50% - .175rem)!important}
 .st-key-nav_grid [data-testid="stPageLink"] a{min-height:40px!important;font-size:.60rem!important}
}
</style>
""", unsafe_allow_html=True)

# Exactly four navigation buttons in one row on desktop and a forced 2x2 grid on mobile.
