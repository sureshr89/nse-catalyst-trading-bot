...
/* Account / strategy metric rows: always 2 columns, matching Current Trading. */
...
[data-testid="stHorizontalBlock"]:has([data-testid="stMetric"]) [data-testid="stMetricLabel"]{
...
/* Match Current Trading typography rather than oversized Analysis headings. */
