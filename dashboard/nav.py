...
@media(max-width:768px){{.st-key-global_nav{{margin:{offset}px 0 10px!important}}.st-key-global_nav [data-testid="stHorizontalBlock"]{{gap:7px!important;margin-bottom:7px!important}}.st-key-global_nav [data-testid="stColumn"]{{width:calc(50% - 3.5px)!important;max-width:calc(50% - 3.5px)!important;flex:0 0 calc(50% - 3.5px)!important}}.st-key-global_nav [data-testid="stButton"] button{{min-height:42px!important;font-size:.72rem!important;font-weight:650!important}}
}}
