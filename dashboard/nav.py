...
.dashboard-nav-row {{ display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:7px; margin-bottom:7px; }}
...
@media(max-width:900px) {{
  .dashboard-nav-row {{ grid-template-columns:repeat(2,minmax(0,1fr)); }}
}}
...
""",
    ...
    with st.container():
        ...
        with d: _button("⬇️ DOWNLOADS", "pages/downloads.py", "nav_s1_downloads")
        ...
        with d: _button("⬇️ DOWNLOADS", "pages/strategy2_downloads.py", "nav_s2_downloads")
