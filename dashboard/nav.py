...
def render_nav():
    ...
    st.markdown(
        ...
        /* Normal document flow: buttons scroll away with the page. */
        .st-key-global_nav {
        ...
        @media(max-width:768px){
            .st-key-global_nav{padding:0 0 8px!important}
            .st-key-global_nav [data-testid="stHorizontalBlock"]{gap:6px!important;margin-bottom:6px!important}
            .st-key-global_nav [data-testid="stPageLink"] a{min-height:44px!important;font-size:.78rem!important}
        }
        </style>
        """,
