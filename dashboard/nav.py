...
def render_nav(top_offset=8):
    """Shared 2x2 navigation in normal page flow."""
    st.markdown(f'''<style>
.st-key-global_nav{{position:relative!important;margin:{top_offset}px 0 12px!important;padding:0!important;width:100%!important}}
...
.st-key-global_nav [data-testid="stButton"] button{{width:100%!important;min-height:48px!important;border:1px solid #2b3b57!important;border-radius:12px!important;background:#142036!important;color:#e9f0f8!important;font-size:.88rem!important;font-weight:700!important;white-space:nowrap!important;padding:8px 5px!important}}
@media(max-width:768px){{.st-key-global_nav{{margin:{top_offset}px 0 10px!important}}.st-key-global_nav [data-testid="stHorizontalBlock"]{{gap:7px!important;margin-bottom:7px!important}}.st-key-global_nav [data-testid="stColumn"]{{width:calc(50% - 3.5px)!important;max-width:calc(50% - 3.5px)!important;flex:0 0 calc(50% - 3.5px)!important}}.st-key-global_nav [data-testid="stButton"] button{{min-height:46px!important;font-size:.76rem!important}}}}
