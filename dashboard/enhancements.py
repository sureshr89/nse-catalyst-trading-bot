...
def render_enhancements():
    ...
    st.markdown("<div class='hero'><h1>📊 NSE CATALYST</h1><small>Paper Trading • ₹2.5L / Strategy • 1 Trade / Strategy / Day</small><small>Only clock + market prices refresh every 25 seconds</small></div>",unsafe_allow_html=True)
