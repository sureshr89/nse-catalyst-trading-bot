...
def test_valid_buy_signal_reaches_trade_contract():
    signal = make_signal('S1', 'BUY', 'ABC', 1000, 994, 0.10, 0.20, 1.20, 500, 'clean S1 test', 999, 1000, 10, 5)
...
def test_invalid_sell_market_alignment_is_rejected():
    signal = make_signal('S1', 'SELL', 'ABC', 1000, 1006, -0.10, 0.20, 1.20, 500, 'bad alignment', 1001, 1000, 10, 5)
