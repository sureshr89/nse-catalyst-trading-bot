...
from engine.strategy_sector_count_gate_patch import install as install_strategy_sector_count_gate_patch
...
install_strategy_sector_count_gate_patch(MasterEngine)
