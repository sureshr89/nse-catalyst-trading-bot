...
STRATEGY_VERSION = "2026.08.18.v2"
STRATEGY_1_NAME = "PDH/PDL + Open Return"
STRATEGY_2_NAME = "Gap Extension Reversal"

STRATEGY_1_RULES = (
    ("BUY", "Today's Open > PDH → price reaches/crosses PDH → live LTP returns to/above Today's Open"),
    ("SELL", "Today's Open < PDL → price reaches/crosses PDL → live LTP returns to/below Today's Open"),
